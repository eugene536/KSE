...
scl1 = Scale(root, from_=0, to=30, resolution=0.1, length=200, orient=HORIZONTAL)
scl1.set(1)
scl1.grid(row = 2, column = 2)

lbl2 = Label(root, text="y0")
lbl2.grid(row = 3, column = 1)
scl2 = Scale(root, from_=0, to=30, resolution=0.1, length=200, orient=HORIZONTAL)
scl2.set(2)
scl2.grid(row = 3, column = 2)

lbl3 = Label(root, text="z0")
lbl3.grid(row = 4, column = 1)
scl3 = Scale(root, from_=0, to=30, resolution=0.1, length=200, orient=HORIZONTAL)
scl3.set(3)
scl3.grid(row = 4, column = 2)

lbl4 = Label(root, text="r")
lbl4.grid(row = 5, column = 1)
scl4 = Scale(root, from_=0, to=30, resolution=0.1, length=200, orient=HORIZONTAL)
scl4.set(4)
