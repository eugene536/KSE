    ...
    inline double get_K(int number, double temp) {
        ...
        switch (number) {
            ...
            case 5:
                ...
                break;
            case 6:
                delta_g = 2 * get_g(Ga, temp) + 6 * get_g(HCl, temp) - 2 * get_g(GaCl3, temp) -
                          3 * get_g(H2, temp);
                break;
            case 9:
                delta_g = 1 * get_g(AlCl3, temp) + 1 * get_g(NH3, temp) - 1 * get_g(AlN, temp) -
                          3 * get_g(HCl, temp) - 0 * get_g(H2, temp);
                break;
            case 10:
                delta_g = 1 * get_g(GaCl, temp) + 1 * get_g(NH3, temp) - 1 * get_g(GaN, temp) -
